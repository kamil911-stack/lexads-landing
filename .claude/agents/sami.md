...
Après avoir rédigé tous les emails, mets à jour `livrables/crm-site/prospects.json` pour chaque prospect Sami.
...
git -C $repo commit -m "Sami: brouillons J0 rediges -- $(Get-Date -Format 'yyyy-MM-dd HH:mm')"
git -C $repo push
```
